...
function getAll() {
    ...
    return fetch(`${ApplicationSettings.API_URL}users`, requestOptions)
    .then((response) => { 
        return response.json().then((data) => {
            console.log("userservice => getAll Respond: users")
            console.log(data);
            return data;
        }).catch((err) => {
            console.log(err);
...
function getById(id) {
    ...
    fetch(`${ApplicationSettings.API_URL}/users/${id}`, requestOptions).then(handleResponse)
    .then(users => {
        console.log("userservice => getById Respond: users")
        console.log(users)
