...
import DetailNonReceptionne from './detail-nonreceptionne';

class NonReceptionne extends React.Component {
  ...
  render() {
    const colisJSX = this.state.loading? 
        this.state.repos.map((elt) => {
          ...
          {
            return (
              <DetailNonReceptionne key={elt.id} colis={elt} { ...this.props } />
            )
          } else { return null;}
        }) : null;
        ...
        <div className="col-12">
          <div className="card">
            <div className="card-header">
              <h3 className="card-title">Liste des colis non réceptionnés</h3>  
