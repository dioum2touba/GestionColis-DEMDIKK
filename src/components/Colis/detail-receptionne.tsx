...
const DetailReceptionne = (props: any) => {
    ...
    return (
        <tr>
            ...
            <td><Moment format="DD/MM/YYYY hh:mm">{props.colis.dateReception}</Moment></td>
            ...
            <td>
                <Button variant="success" onClick={() => handleReceptionColis(props.colis.id)} className="btn btn-sm">
...
export default DetailReceptionne;